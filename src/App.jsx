    ...
    try {
      ...
      if (ethereum) {
        ...
        connectedContract.on("NewEpicNFTMinted", (from, tokenId) => {
          ...
          alert(`Hey there! We've minted yuor NFT and sent it ti your wallet. It may be blank right now. It can take a max of 10 min to show up on OpenSea. Here's the link: https://testnets.opensea.io/assets/${CONTRACT_ADDRESS}/${tokenId.toNumber()}`);
        });
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        console.log("Going to pop wallet now to pat gas...");
